...
se    = pd.read_csv("GWNBR/11_gwnbr_local_se.csv")
...
bw = pd.read_csv("GWNBR/11_gwnbr_bandwidth.csv")
...
add_scalebar(ax)
add_north_arrow(ax)
plt.savefig("GWNBR/13_imd_local_coef.png", dpi=200, bbox_inches="tight")
plt.close()
print("图1已保存：GWNBR/13_imd_local_coef.png")
...
add_north_arrow(ax)
plt.tight_layout()
plt.savefig("GWNBR/13_imd_significance.png", dpi=200, bbox_inches="tight")
plt.close()
print("图2已保存：GWNBR/13_imd_significance.png")
...
add_north_arrow(ax)
plt.tight_layout()
plt.savefig("GWNBR/13_imd_coef_significant_only.png", dpi=200, bbox_inches="tight")
plt.close()
print("图3已保存：GWNBR/13_imd_coef_significant_only.png")
