...
df.to_csv("GWNBR_noblack/bandwidth=240/10_regression_with_coords.csv", index=False, encoding="utf-8-sig")

print("完成！")
print(f"  输出行数: {len(df):,}")
print(f"  输出文件: GWNBR_noblack/bandwidth=240/10_regression_with_coords.csv")
