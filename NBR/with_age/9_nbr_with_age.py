...
# 变量列表（参照组：White, Mixed_or_Multiple，restaurant_cafe_canteen；含 age 变量）
controls = [
    "age_0_4", "age_65plus",
    "Asian", "Black", "Other",
...
summary_df.to_csv("NBR/9_nbr_results_with_age.csv", index=False, encoding="utf-8-sig")
...
metrics.to_csv("NBR/9_nbr_metrics_with_age.csv", index=False, encoding="utf-8-sig")

print("\n结果已保存：NBR/9_nbr_results_with_age.csv、NBR/9_nbr_metrics_with_age.csv")
print("\n── 模型评价指标 ──")
